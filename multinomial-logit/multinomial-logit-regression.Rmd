...
\nu_n = X_n \times \beta \\
\alpha^{\text{age}} = \sigma^\text{age} \times \eta^\text{age},\,\,\alpha^{\text{edu}} = \sigma^\text{edu} \times \eta^\text{edu}, \,\, \alpha^{\text{eth}} = \sigma^\text{eth} \times \eta^\text{eth} \\
...
\alpha^{\text{age}} = \sigma^\text{age} \times \eta^\text{age},\,\,\alpha^{\text{state}} = \sigma^\text{state} \times \eta^\text{state} \\
